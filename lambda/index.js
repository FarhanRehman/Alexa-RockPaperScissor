...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to rock paper scissor, what is your move?';
...
const GameIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        {
            case 'rockrock':
                speakOutput="you played rock and i played rock, it is a tiel ";
                break;
            case 'rockpaper':
            ...
            case 'scissorpaper':
                ...
                break;
            case 'scissorscissor':
                speakOutput+="you played scissor and i played scissor, it is a tiel ";
                break;
            default:
                 break;
        }
